...
$result = "SELECT QuClRank,QuHits,QuGold,QuXnine, QuScore, EnCode, EnName, EnFirstName,EnTournament,EnCountry, ToName, QuID, EnID, EnCode, IndRankFinal, CONCAT(EnName,' ', EnFirstName)AS Name,CONCAT(EnDivision,EnClass)AS Event, CoName,QuD1Rank,QuD1Score,QuD1Hits,QuD1Gold FROM Qualifications, Entries, Individuals, Tournament, Countries WHERE QuD1Rank='1' AND EnDivision='C' AND EnClass='M' AND CoID=EnCountry AND QuID=EnID AND EnID = IndID AND EnTournament=ToID AND EnTournament= " . StrSafe_DB($_SESSION['TourId']) . " ORDER BY Event DESC, QuClRank ASC";

$result1 = "SELECT QuClRank,QuHits,QuGold,QuXnine, QuScore, EnCode, EnName, EnFirstName,EnTournament,EnCountry, ToName, QuID, EnID, EnCode, IndRankFinal, CONCAT(EnName,' ', EnFirstName)AS Name,CONCAT(EnDivision,EnClass)AS Event, CoName,QuD2Rank,QuD2Score,QuD2Hits,QuD2Gold FROM Qualifications, Entries, Individuals, Tournament, Countries WHERE QuD2Rank='1' AND EnDivision = 'C' AND EnClass='M' AND CoID=EnCountry AND QuID=EnID AND EnID = IndID AND EnTournament=ToID AND EnTournament= " . StrSafe_DB($_SESSION['TourId']) . " ORDER BY Event DESC, QuClRank ASC";

$result2 = "SELECT QuClRank,QuHits,QuGold,QuXnine, QuScore, EnCode, EnName, EnFirstName,EnTournament,EnCountry, ToName, QuID, EnID, EnCode, IndRankFinal, CONCAT(EnName,' ', EnFirstName)AS Name,CONCAT(EnDivision,EnClass)AS Event, CoName,QuD3Rank,QuD3Score,QuD3Hits,QuD3Gold FROM Qualifications, Entries, Individuals, Tournament, Countries WHERE QuD3Rank='1' AND EnDivision = 'C' AND EnClass='M' AND CoID=EnCountry AND QuID=EnID AND EnID = IndID AND EnTournament=ToID AND EnTournament= " . StrSafe_DB($_SESSION['TourId']) . " ORDER BY Event DESC, QuClRank ASC";

$result3 = "SELECT QuClRank,QuHits,QuGold,QuXnine, QuScore, EnCode, EnName, EnFirstName,EnTournament,EnCountry, ToName, QuID, EnID, EnCode, IndRankFinal, CONCAT(EnName,' ', EnFirstName)AS Name,CONCAT(EnDivision,EnClass)AS Event, CoName,QuD4Rank,QuD4Score,QuD4Hits,QuD4Gold FROM Qualifications, Entries, Individuals, Tournament, Countries WHERE QuD4Rank='1' AND EnDivision = 'C' AND EnClass='M' AND CoID=EnCountry AND QuID=EnID AND EnID = IndID AND EnTournament=ToID AND EnTournament= " . StrSafe_DB($_SESSION['TourId']) . " ORDER BY Event DESC, QuClRank ASC";
